                    	...
                    	<tr align="center">
                        	<td align="center" style="height: 25px; text-align: center;">
                                ...
                                <s:if test="currentPage > 1">
									<a href="guide_list?currentPage=${currentPage - 1}">上一页</a>&nbsp;&nbsp;
								</s:if>
								<s:if test="currentPage != totalPage">
									<a href="guide_list?currentPage=${currentPage + 1}">下一页</a>&nbsp;&nbsp;
								</s:if>
								跳转至第
								<input style="width: 20px; height: 12px;" type="text" onkeydown="if(event.keyCode==13) if(isNaN(this.value) || this.value < 1 || this.value > ${totalPage}) alert('请输入页数范围内的数字'); else window.location = 'guide_list?currentPage=' + this.value;"/>
                                                                                      页
                            </td>
	                    </tr>
                    </s:if>
