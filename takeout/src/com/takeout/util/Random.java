...
public class Random extends java.util.Random {
	 ...
	 *
	 */
	private static final long serialVersionUID = -7960276739648203254L;
	...
	public static char nextLetter() {
		return R.nextBoolean() ? letter[R.nextInt(26)] : Character.toUpperCase(letter[R.nextInt(26)]);
	}
	...
	public static String nextPlate() {
		...
		return Random.nextString(prefix) + Random.nextCapitalLetter() + "-" + Random.nextNumberString("6");
	}
